/*----------------------------------------------------------------------------
Snowflake and Sagemaker Dev Days Virtual Workshop V1.5
Configure Snowflake environment and load data into Snowflake directly from dataframe
...
Execute each section at a time following the steps
  ...
  Update: September15, 2020 
  Remove Internal Stage as it is no longer needed
  Remove COPY from Internal Stage
...
--Let's look at the CHURN SCORES from Sagemaker
